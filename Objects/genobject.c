...
static PyObject *
gen_get_name(PyGenObject *op, void *context)
{
...
static int
gen_set_name(PyGenObject *op, PyObject *value, void *context)
{
...
static PyObject *
gen_get_qualname(PyGenObject *op, void *context)
{
...
static int
gen_set_qualname(PyGenObject *op, PyObject *value, void *context)
{
...
static PyObject *
gen_getyieldfrom(PyGenObject *gen, void *context)
{
    PyObject *yf = _PyGen_yf(gen);
    if (yf == NULL)
        Py_RETURN_NONE;
...
static PyObject *
coro_get_cr_await(PyCoroObject *coro, void *context)
{
