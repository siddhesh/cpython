...
static PyObject*
stringlib_lower(PyObject *self, void *unused)
{
    PyObject* newobj;
...
static PyObject*
stringlib_upper(PyObject *self, void *unused)
{
    PyObject* newobj;
    newobj = STRINGLIB_NEW(NULL, STRINGLIB_LEN(self));
    if (!newobj)
...
static PyObject*
stringlib_title(PyObject *self, void *unused)
{
    PyObject* newobj;
    newobj = STRINGLIB_NEW(NULL, STRINGLIB_LEN(self));
    if (!newobj)
...
static PyObject*
stringlib_swapcase(PyObject *self, void *unused)
{
    PyObject* newobj;
    newobj = STRINGLIB_NEW(NULL, STRINGLIB_LEN(self));
    if (!newobj)
