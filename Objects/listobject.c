...
static PyObject *listiter_len(listiterobject *, void *unused);
...
static PyObject *
listiter_len(listiterobject *it, void *unused)
{
    Py_ssize_t len;
    if (it->it_seq) {
...
static PyObject *
listiter_reduce(listiterobject *it, void *unused)
{
...
static PyObject *
listreviter_len(listreviterobject *it, void *unused)
{
...
static PyObject *
listreviter_reduce(listreviterobject *it, void *unused)
{
