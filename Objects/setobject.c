...
static PyObject *
set_pop(PySetObject *so, void *unused)
{
...
static PyObject *
setiter_len(setiterobject *si, void *unused)
{
    Py_ssize_t len = 0;
...
static PyObject *
setiter_reduce(setiterobject *si, void *unused)
{
    PyObject *list;
    setiterobject tmp;
...
static PyObject *
set_copy(PySetObject *so, void *unused)
{
    return make_new_set_basetype(Py_TYPE(so), (PyObject *)so);
}

static PyObject *
frozenset_copy(PySetObject *so, void *unused)
{
...
static PyObject *
set_clear(PySetObject *so, void *unused)
{
...
static PyObject *
set_reduce(PySetObject *so, void *unused)
{
...
static PyObject *
set_sizeof(PySetObject *so, void *unused)
{
    Py_ssize_t res;
...
#ifdef Py_DEBUG
static PyObject *test_c_api(PySetObject *so, void *unused);
...
static PyObject *
test_c_api(PySetObject *so, void *unused)
{
    Py_ssize_t count;
    const char *s;
    Py_ssize_t i;
