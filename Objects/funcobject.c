...
static PyObject *
func_get_qualname(PyFunctionObject *op, void *closure)
{
    Py_INCREF(op->func_qualname);
...
static int
func_set_qualname(PyFunctionObject *op, PyObject *value, void *closure)
{
...
static PyObject *
func_get_kwdefaults(PyFunctionObject *op, void *closure)
{
...
static int
func_set_kwdefaults(PyFunctionObject *op, PyObject *value, void *closure)
{
    if (value == Py_None)
        value = NULL;
...
static PyObject *
func_get_annotations(PyFunctionObject *op, void *closure)
{
...
static int
func_set_annotations(PyFunctionObject *op, PyObject *value, void *closure)
{
    if (value == Py_None)
        value = NULL;
