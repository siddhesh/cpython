...
static PyObject *
stdprinter_fileno(PyStdPrinter_Object *self, void *unused)
{
...
static PyObject *
stdprinter_noop(PyStdPrinter_Object *self, void *unused)
{
    Py_RETURN_NONE;
}

static PyObject *
stdprinter_isatty(PyStdPrinter_Object *self, void *unused)
{
    long res;
    if (self->fd < 0) {
        Py_RETURN_FALSE;
