...
static PyObject *
deque_copy(PyObject *deque, void *unused)
{
...
static PyObject *
deque_clearmethod(dequeobject *deque, void *unused)
{
    deque_clear(deque);
    Py_RETURN_NONE;
}
...
static PyObject *
deque_get_maxlen(dequeobject *deque, void *unused)
{
    if (deque->maxlen < 0)
        Py_RETURN_NONE;
...
static PyObject *deque_reviter(dequeobject *deque, void *unused);
...
static PyObject *
dequeiter_len(dequeiterobject *it, void *unused)
{
...
static PyObject *
dequeiter_reduce(dequeiterobject *it, void *unused)
{
...
static PyObject *
deque_reviter(dequeobject *deque, void *unused)
{
    dequeiterobject *it;
...
static PyObject *
defdict_copy(defdictobject *dd, void *unused)
{
...
static PyObject *
defdict_reduce(defdictobject *dd, void *unused)
{
