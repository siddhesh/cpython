...
static PyObject *
itemgetter_reduce(itemgetterobject *ig, void *unused)
{
    if (ig->nitems == 1)
...
static PyObject *
attrgetter_reduce(attrgetterobject *ag, void *unused)
{
    PyObject *attrstrings = attrgetter_args(ag);
    if (attrstrings == NULL)
        return NULL;
...
static PyObject *
methodcaller_reduce(methodcallerobject *mc, void *unused)
{
    PyObject *newargs;
